                ...
                <div id="emailHelp" class="form-text">
                    ...
                    <div class="row">
                        <div class="mb-3 col-6">
                            ...
                            <input type="text" value="${form.firstName}" name="firstName" class="form-control"
                        ...
                        <div class="mb-3 col-6">
                            ...
                            <input type="text" value="${form.lastName}" name="lastName" class="form-control"
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" value="${form.avatar}" name="avatar" class="form-control" id="avatar"
                            aria-describedby="avatarHelp">
                        <div id="avatarHelp" class="form-text">Enter the full URL that you want for your avatar image
                        </div>
                    </div>
                    <p>Opt-in to recieve emails</p>
                    Yes
                    <input type="radio" name="opt-in" value="Yes" checked>
                    No
                    <input type="radio" name="opt-in" value="No">
                </div>
                <br>
                <div>
